...
subroutine feval(neqn,t,c,f,coef,ipar)
	...
	real(kind(1.d0)), save :: n_quad_form_extra(23,0:24)=0.d0
...
subroutine initialize_parameters(coef_quad,coef_lin,ind_quad_loss,ind_quad_form,&
	...
	implicit none
	integer, parameter :: neqn=16, nclust=16
	logical :: isconst(16)
...
subroutine get_rate_coefs(coef_quad,coef_lin,coef)
	implicit none
	real(kind(1.d0)) :: coef_quad(16,16,23),coef_lin(23,23,16)
	real(kind(1.d0)) :: K(16,16),E(16,16),cs(16)
	real(kind(1.d0)) :: coef(1)
...
subroutine get_evap(E,K,temperature)
	implicit none
	real(kind(1.d0)) :: E(16,16), K(16,16), temperature
	...
	E(5,1) = 7.33893243358348d+027/temperature*exp(&
			 &((-66.06d0/temperature-(-107.72d0)/1.d3)&
			 &-(-45.00d0/temperature-(-71.02d0)/1.d3)&
			 &-0.d0)&
	...
	E(5,3) = 7.33893243358348d+027/temperature*exp(&
			 &((-64.46d0/temperature-(-104.45d0)/1.d3)&
			 &-(-45.00d0/temperature-(-71.02d0)/1.d3)&
			 &-0.d0)&
	...
	E(7,1) = 7.33893243358348d+027/temperature*exp(&
			 &((-92.09d0/temperature-(-143.18d0)/1.d3)&
			 &-(-64.46d0/temperature-(-104.45d0)/1.d3)&
			 &-0.d0)&
	...
	E(8,1) = 7.33893243358348d+027/temperature*exp(&
			 &((-115.13d0/temperature-(-183.34d0)/1.d3)&
			 &-(-92.09d0/temperature-(-143.18d0)/1.d3)&
			 &-0.d0)&
	...
	E(8,3) = 7.33893243358348d+027/temperature*exp(&
			 &((-116.60d0/temperature-(-177.99d0)/1.d3)&
			 &-(-92.09d0/temperature-(-143.18d0)/1.d3)&
			 &-0.d0)&
	...
	E(10,1) = 7.33893243358348d+027/temperature*exp(&
			 &((-145.17d0/temperature-(-222.33d0)/1.d3)&
			 &-(-116.60d0/temperature-(-177.99d0)/1.d3)&
			 &-0.d0)&
	...
	E(11,1) = 7.33893243358348d+027/temperature*exp(&
			 &((-168.79d0/temperature-(-260.55d0)/1.d3)&
			 &-(-145.17d0/temperature-(-222.33d0)/1.d3)&
			 &-0.d0)&
	...
	E(11,3) = 7.33893243358348d+027/temperature*exp(&
			 &((-164.35d0/temperature-(-251.03d0)/1.d3)&
			 &-(-145.17d0/temperature-(-222.33d0)/1.d3)&
			 &-0.d0)&
	...
	E(13,1) = 7.33893243358348d+027/temperature*exp(&
			 &((-191.86d0/temperature-(-291.05d0)/1.d3)&
			 &-(-164.35d0/temperature-(-251.03d0)/1.d3)&
			 &-0.d0)&
